...
class RayPPOTrainer:
    ...
    # NOTE: Visualization / on-disk dumping helpers intentionally removed for clean training-only runs.
    ...
    def fit(self):
        ...
        # wzx: validate should modify? depends on the gold answer
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # No rollout JSONL dumping (training-only).
