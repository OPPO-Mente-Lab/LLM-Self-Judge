...
if __name__ == "__main__":
    ...
    # Example usage:
    #   python data/geo3k.py --local_dataset_path data/geometry3k/data --local_save_dir data/geo3k_parquet
    # If you don't have the raw dataset locally, omit --local_dataset_path to download from HuggingFace.
